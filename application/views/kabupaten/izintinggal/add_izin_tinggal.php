    ...
    <div class="modal fade" id="add_izin_tinggal<?php echo $row['id'] ?>">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="bd p-15">
                    <h5 class="m-0">Tambah Data Izin Tinggal <span style="color: #490411"><?php echo $row['nama_panjang']; ?></span></h5>
                </div>
                <div class="modal-body">
                    <form method="POST"
                          action="izintinggal/data_itk/<?php echo hashids_encrypt($row['id']);?>/t" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input onkeyup="this.value = this.value.toUpperCase();" class="form-control border-grey" value="<?php echo ($row['no_paspor']);?>"
                        ...
                        <div class="text-right">
                            ...
                            <button class="btn btn-success cur-p" name="btn_simpan_public" id="btn_simpan_public">
                                Simpan Data ITK
                            </button>
                        </div>
                    </form>
...
<script type="text/javascript">
    // $(document).on('click', '#btn_simpan_public', function() {
